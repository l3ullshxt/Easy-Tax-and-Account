 ...
 * ระวัง: ถ้าคัดลอกไฟล์นี้ไปวางทับใน Apps Script อีเมลที่เพิ่มไว้ในนั้นจะถูกเขียนทับ
 * ให้ใส่อีเมลเพิ่มเติม (เช่น อีเมลส่วนตัว) ในหน้า Apps Script เอง ไม่ต้องใส่ในไฟล์นี้
 */
const NOTIFY_EMAILS = 'easytaxandacc@gmail.com';
